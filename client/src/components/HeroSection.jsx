...
lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <h1>Guardians <br />of the Galaxy</h1>
        <div className='flex items-center gap-4 text-gray-300'>
          ...
          <div>
            <CalendarIcon className="w-4.5 h-4.5"/>2020
          </div>
          <div>
            <ClockIcon className="w-4.5 h-4.5"/> 2h 8m
          </div>
        </div>
        <p className='max-w-md text-gray-300'> In a post-apocalyptic world where cities ride on wheels and consume each other to survive, two people meet Lonodon and try to stop a conspiracy.
        </p>
